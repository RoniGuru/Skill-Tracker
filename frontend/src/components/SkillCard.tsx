...
const SkillCard: React.FC<SkillComponentProps> = ({ skill }) => {
  ...
  return (
    <div className="flex w-1/4  flex-col text-center text-gray-700 dark:text-gray-400  p-6 bg-white border border-gray-200 rounded-lg shadow hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700 items-center">
